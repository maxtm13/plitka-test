...
$APPLICATION->SetPageProperty("description", "Ищете идеальное напольное покрытие? В «ПлиткаНаДом» представлен широкий выбор напольных покрытий для любого интерьера✅ плинтусы✔️, террасная доска✔️, ламинат✔️, паркет и многое другое✔️. Большой каталог напольного покрытия по телефону ☎️ +7(495)77-77-121");
$APPLICATION->SetPageProperty("title", "Напольные покрытие - купить в Москве, цены в каталоге «ПлиткаНаДом»");
...
if (isset($_REQUEST['set_filter']) || (substr_count($APPLICATION->GetCurPageParam(), 'set_filter=') > 0)) {
	...
	array(
		...
		"TYPE" => "collect",
		"COMPONENT_TEMPLATE" => "category_menu",
