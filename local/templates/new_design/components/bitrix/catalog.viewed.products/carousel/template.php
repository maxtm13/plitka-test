...
$this->addExternalCSS(SITE_TEMPLATE_PATH."/js/owl/assets/owl.carousel.css");
$this->addExternalCSS(SITE_TEMPLATE_PATH."/js/owl/assets/owl.theme.default.css?1");
$this->addExternalJS(SITE_TEMPLATE_PATH."/js/owl/owl.carousel.min.js");
...
if (!empty($arResult['ITEMS'])) {
    ...
    <div class="bx_item_list_you_looked_horizontal itemsCarousel <? echo $templateData['TEMPLATE_CLASS']; ?> <?=$arParams['EXT_CLASS']?>">
        ...
        <div class="bx_item_list_section">
            <div class="owl-carousel owl-theme" id="<?=$owlID?>">
                ...
                foreach ($arResult['ITEMS'] as $key => $arItem) {
                    ...
                    $notAvail = in_array($arItem['PROPERTIES']['AVAILABILITY']['VALUE_ENUM_ID'], array(4914, 5044, 5649));?>
                    <div class="<? echo($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>" id="<? echo $strMainID; ?>">
                        <div class="bx_catalog_item_container <? echo $showImgClass; ?>">
                            <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images"<? if ($arParams['SHOW_IMAGE'] == "Y") {?> style="background-image: url('<? echo($arParams['SHOW_IMAGE'] == "Y" ? $arItem['PREVIEW_PICTURE']['SRC'] : ""); ?>')"<?}?> title="<? echo $strTitle; ?>">
                            ...
                            <?if ($arItem['SECOND_PICT']) {?>
                                <a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double"<? if ($arParams['SHOW_IMAGE'] == "Y") {?> style="background-image: url('<?/* echo(
                !empty($arItem['PREVIEW_PICTURE_SECOND'])
                ? $arItem['PREVIEW_PICTURE_SECOND']['SRC']
                : $arItem['PREVIEW_PICTURE']['SRC']
            ); */  echo $arItem['PREVIEW_PICTURE']['SRC'] ?>')"<?}?> title="<? echo $strTitle; ?>"><?if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {?>
                            ...
                            <div class="bx_catalog_item_price">
                                <div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
                                    <?if (!empty($arItem['PROPERTIES']['AVAILABILITY']['VALUE_ENUM_ID']) && $notAvail) {
                                        ...
                                        if ('Y' == $arParams['SHOW_OLD_PRICE'] && $arItem['MIN_PRICE']['DISCOUNT_VALUE'] < $arItem['MIN_PRICE']['VALUE']) {
                                            ?> <br/><span style="color: #a5a5a5;font-size: 12px;font-weight: normal;white-space: nowrap;text-decoration: line-through;"><? echo $arItem['MIN_PRICE']['PRINT_VALUE']; ?></span>
                                        <?}
                                    }?>
                                </div>
                            </div>
