...
$MESS['SOA_TEMPL_ORDER_SUC'] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно создан. В ближайшее время с Вами свяжется наш менеджер. ";
...
$MESS['SOA_TEMPL_SUM_COMMENTS'] = "Комментарии к заказу: <br>(если это Дозаказ, то напишите тут номер предыдущего заказа):";
