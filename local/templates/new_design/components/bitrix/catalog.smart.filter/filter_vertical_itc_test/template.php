            ...
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                <? foreach ($arResult["HIDDEN"] as $arItem):?>
                    <input
                            type="hidden"
                            name="<?
                            echo $arItem["CONTROL_NAME"] ?>"
                            id="<?
                            echo $arItem["CONTROL_ID"] ?>"
                            value="<?
                ...
                <? foreach ($arResult["ITEMS"] as $key => $arItem): ?>
                    <? if ($arItem["PROPERTY_TYPE"] == "N"): ?>
                        ...
                        <div class="bx_filter_container price">
                            <span class="bx_filter_container_modef"></span>
                            <span class="bx_filter_container_title prop_<?php echo $arItem['ID']; ?>"><? /*<span class="bx_filter_container_modef"></span>*/ ?><?= $arItem["NAME"] ?></span>
                ...
                <div class="bx_filter_control_section">
                    ...
                    <?php if (!empty($arParams['SEARCH_EVERYWHERE'])) { ?>
                        <br/><a class="bx_filter_search_button_1"
                                href="<?php echo $arParams['SEARCH_EVERYWHERE']; ?>#fltr_params"><?= GetMessage("PND_SEARCH_EVERYWHERE") ?></a>
                    <?php } ?>
