...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if (($hour == 20 && $minutes >= 30 || $hour > 20 || $hour == 8 && $minutes <= 30 || $hour < 8) && in_array($arParams['IBLOCK_ID'], array(CATALOG_FLOOR_ID, CATALOG_SANTEH_ID))) {
...
echo "<!--<pre>";
print_r($arParams["BRAND"]["SECTIONS"]);
echo "</pre>-->";
