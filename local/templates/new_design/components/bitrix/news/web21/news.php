...
<?if($arParams["USE_RSS"]=="Y"):?>
	...
	?>
	<a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["rss"]?>" title="rss" target="_self"><img class="img-rss" title="RSS" alt="RSS" src="<?=$templateFolder?>/images/gif-light/feed-icon-16x16.gif"/></a>
<?endif?>
