...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="bx-newslist-block simple">
		<?if($arParams["DISPLAY_PICTURE"]!="N"):?>
			...
			<?elseif ($arItem["SLIDER"]):?>
				<div class="bx-newslist-img">
					<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
						<a href="<? echo $arItem['PROPERTIES']['URL_NEWS_CLIENTS']['VALUE'];?>"><img
			...
			<?elseif (is_array($arItem["PREVIEW_PICTURE"])):?>
				<div class="bx-newslist-img">
				<div class="bx-newslist-img2223">
				<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
					<a href="<? echo $arItem['PROPERTIES']['URL_NEWS_CLIENTS']['VALUE'];?>"><img
					        class="bx-newslist-img-scream"
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<h3 class="bx-newslist-title">
				<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
					<a href="<? echo $arItem['PROPERTIES']['URL_NEWS_CLIENTS']['VALUE'];?>"><?echo $arItem["NAME"]?></a>
				<?else:?>
					<?echo $arItem["NAME"]?>
				<?endif;?>
			</h3>
		...
		<div class="row">
			<div class="col-xs-5">
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<div class="bx-newslist-more"><a class="btn btn-primary btn-xs" href="<? echo $arItem['PROPERTIES']['URL_NEWS_CLIENTS']['VALUE'];?>"><?echo GetMessage("CT_BNL_GOTO_DETAIL")?></a></div>
