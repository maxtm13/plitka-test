			...
			<td class="basket-items-list-item-notification" colspan="<?=$restoreColSpan?>">
				<div class="basket-items-list-item-notification-inner basket-items-list-item-notification-removed" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-items-list-item-removed-container">
						<div>
							<?=Loc::getMessage('SBB_GOOD_CAP')?> <strong>{{REMOVE_NAME}}</strong> <?=Loc::getMessage('SBB_BASKET_ITEM_DELETED')?>.
						</div>
				...
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					if (in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST']))
					{
						...
						<div class="basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '')?>">
							{{#DETAIL_PAGE_URL}}
								<a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link{{^IMAGE_URL}} no-img{{/IMAGE_URL}}" style="background-image:url({{{IMAGE_URL}}});">
							{{/DETAIL_PAGE_URL}}
							{{#SHOW_LABEL}}
					...
					data-entity="basket-item-quantity-block">
							...
							<div class="basket-item-amount-filed-block">
								<input type="text" class="basket-item-amount-filed" maxlength="5" value="{{QUANTITY}}"
									{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
									data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
									id="basket-item-quantity-{{ID}}" onchange="checkpoint('basket-item-quantity-{{ID}}')">
							</div>
							<span class="basket-item-amount-btn-plus" data-entity="basket-item-quantity-plus"></span>
							<div class="basket-item-measure">за {{MEASURE_TEXT}}</div>
							{{#SHOW_LOADING}}
								<div class="basket-items-list-item-overlay"></div>
							{{/SHOW_LOADING}}
						</div>
					...
					{
						?>
						<div class="basket-item-block-price curprice">
							<div class="basket-item-price-current">
								{{#SHOW_DISCOUNT_PRICE}}
									<div class="basket-item-price-old">
										<span class="basket-item-price-old-text">
											<span class="basket-item-price-discount">-{{{DISCOUNT_PRICE_PERCENT_FORMATED}}}</span>{{{FULL_PRICE_FORMATED}}}
										</span>
									</div>
								{{/SHOW_DISCOUNT_PRICE}}
						...
						<div class="basket-item-block-price allsumm">
							<div class="basket-item-price-current">
								{{#SHOW_DISCOUNT_PRICE}}
									<div class="basket-item-price-old">
										<span class="basket-item-price-old-text">
											<span class="basket-item-price-discount">-{{{DISCOUNT_PRICE_PERCENT_FORMATED}}}</span><span id="basket-item-sum-price-old-{{ID}}">{{{SUM_FULL_PRICE_FORMATED}}}</span>
										</span>
									</div>
								{{/SHOW_DISCOUNT_PRICE}}
					...
					<div class="basket-item-block-actions">
						<span class="basket-item-actions-remove" data-entity="basket-item-delete">
							<svg width="14" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M268 416h24a12 12 0 0 0 12-12V188a12 12 0 0 0-12-12h-24a12 12 0 0 0-12 12v216a12 12 0 0 0 12 12zM432 80h-82.41l-34-56.7A48 48 0 0 0 274.41 0H173.59a48 48 0 0 0-41.16 23.3L98.41 80H16A16 16 0 0 0 0 96v16a16 16 0 0 0 16 16h16v336a48 48 0 0 0 48 48h288a48 48 0 0 0 48-48V128h16a16 16 0 0 0 16-16V96a16 16 0 0 0-16-16zM171.84 50.91A6 6 0 0 1 177 48h94a6 6 0 0 1 5.15 2.91L293.61 80H154.39zM368 464H80V128h288zm-212-48h24a12 12 0 0 0 12-12V188a12 12 0 0 0-12-12h-24a12 12 0 0 0-12 12v216a12 12 0 0 0 12 12z"></path></svg>
						</span>
						{{#SHOW_LOADING}}
							<div class="basket-items-list-item-overlay"></div>
						{{/SHOW_LOADING}}
