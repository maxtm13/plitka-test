<?php
if (array_key_exists('AJAX_ITEMS',$_REQUEST) && $_REQUEST["AJAX_ITEMS"] == "undefined" || array_key_exists('RID',$_REQUEST) && $_REQUEST["AJAX_ITEMS"] == "undefined"){
	die();
}else{
	...
	$APPLICATION->IncludeComponent(
		"omniweb:catalog.bigdata.products",
		$template,
