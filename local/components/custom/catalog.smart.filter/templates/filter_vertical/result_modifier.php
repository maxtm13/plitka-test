...
// Найдем минимальную и максимальную цену для поиска
$minPrice = 100;
$maxPrice = 10000;
/*$arFilter =  array(
...
global $sotbitFilterResult, $catalogSmartFilterResult;
$sotbitFilterResult = $catalogSmartFilterResult = $arResult;
